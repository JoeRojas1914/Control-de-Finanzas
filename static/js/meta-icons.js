const _META_ICONS_PATHS = {
  ...
  graduacion: `<path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/>`,
  ...
  alcancia:   `<path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2h0V5z"/><path d="M2 9v1a2 2 0 0 0 2 2h1"/><path d="M16 11h0"/>`,
...
const _META_LABELS = {
  target: 'Meta', home: 'Casa', car: 'Auto', plane: 'Viaje',
  smartphone: 'Gadget', graduacion: 'Educación', corazon: 'Salud',
  regalo: 'Regalo', estrella: 'Especial', rayo: 'Fitness',
  camara: 'Foto', libro: 'Libros', alcancia: 'Alcancía',
  maletin: 'Negocio', cafe: 'Ocio', tendencia: 'Inversión',
};

function _metaIcono(key, size = 18) {
  const paths = _META_ICONS_PATHS[key] || _META_ICONS_PATHS.target;
